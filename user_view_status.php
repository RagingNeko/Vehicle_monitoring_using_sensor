...
<a href="user_parking.php" class="btn btn-primary">Back</a>
</div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        sensors.forEach(sensor => {
            ...
            setInterval(async () => {
                ...
                updateSensorStatus(sensorNumber, updatedStatus);
            }, 2000);
        });
    });
    ...
    function addSensorToUI(sensorNumber, sensorId, status, width = 200, height = 200, top = 0, left = 0,ip) {
        ...
        if (document.getElementById(`sensor-${sensorNumber}`)) return; // Avoid duplicates
