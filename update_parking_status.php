...
<div class="parking_image">
    ...
    <nav>
        <!-- Dropdown Button for Editing Positions -->
        <div class="btn-group">
        ...
        <!-- Add Sensor Button -->
        <button type="button" class="tbtn btn btn-primary" data-bs-toggle="modal" data-bs-target="#addSensorModal">
            Add Sensor
        </button>
    </nav>
</header>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="add_sensor.php" method="post">
                    ...
                    <div class="mb-3">
                        <label for="top" class="form-label">Top Position (px)</label>
                        <input type="number" id="top" name="top" class="form-control" required>
                    </div>
                    <div class="mb-3">
                        <label for="left" class="form-label">Left Position (px)</label>
                        <input type="number" id="left" name="left" class="form-control" required>
                    </div>
                    <div class="mb-3">
